...
def reactionSelection(reac):
	...
	if reactionNum == 1:
		wordsBefore = "\\rspd=80\\ sorry I made a mistake"
		sleepTime = 3
...
def IntroduceNao():
	...
	#story_num1 = rospy.get_param("fox_story_en")
	#sayFromFile(story, story_num1, 'ascii')
	story.say("\\rspd=80\\ Hello \\pau=500\\ My name is nao \\pau=500\\ I really like reading short stories")
	story.say("\\rspd=80\\ Do you want to listen to them?")
	time.sleep(2)
	story.say("\\rspd=80\\ If you like, please press start")
	time.sleep(5)
